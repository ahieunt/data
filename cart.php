	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-ship"><?php esc_html_e( 'Ship nhanh', 'woocommerce' ); ?></th>
				<th class="product-ship"><?php esc_html_e( 'Ship chậm', 'woocommerce' ); ?></th>
		...
		<tbody>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td>
						<?php echo get_post_meta( $product_id, '_ship_nhanh', true ) ;?>
						</td>

						<td>
						<?php echo get_post_meta( $product_id, '_ship_cham', true ) ;?>
						</td>
							<?php $tong_ship_nhanh += get_post_meta( $product_id, '_ship_nhanh', true ); 
								$tong_ship_cham += get_post_meta( $product_id, '_ship_cham', true );
							 ?>
			...
			<tr>
				<td><?php echo "Tổng ship nhanh: " .$tong_ship_nhanh ; ?></td>
			</tr>
			<tr>
				<td><?php echo "Tổng ship chậm: " .$tong_ship_cham ; ?></td>
			</tr>
